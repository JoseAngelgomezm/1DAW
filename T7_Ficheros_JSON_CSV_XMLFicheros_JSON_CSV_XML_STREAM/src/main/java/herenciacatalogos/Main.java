...
public class Main {
    ...
    private static Vehiculo pedirDatosVehiculo() {
        ...
        Vehiculo nuevoVehiculo = new Vehiculo(bastidor, matricula, Colores.values()[color - 1]// el color es igual al valor menos 1 ya que el indice del enum empieza en 0
                ,
