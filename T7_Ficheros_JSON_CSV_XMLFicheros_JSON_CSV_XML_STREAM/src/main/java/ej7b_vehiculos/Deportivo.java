...
public class Deportivo extends Factura {
    ...
    public Deportivo(int cilindrada, String bastidor, String matricula, Colores color, Modelo modelo, double tarifa) {
