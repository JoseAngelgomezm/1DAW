...
public class Conexion {
    ...
    private static final String NOMBRE_BASE_DATOS = "p81JoseAngelGomezMorillo";
    private static final String USER = "joseangel";
    private static final String PASS = "programacion123";
