 ...
 * @author joseangel
 */
public class TarjetaBancariaJpaController1 implements Serializable {

    public TarjetaBancariaJpaController1(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(TarjetaBancaria tarjetaBancaria) {
        ...
        try {
            ...
            if (cliente != null) {
                TarjetaBancaria oldTarjetaOfCliente = cliente.getTarjeta();
                if (oldTarjetaOfCliente != null) {
                    oldTarjetaOfCliente.setCliente(null);
                    oldTarjetaOfCliente = em.merge(oldTarjetaOfCliente);
                }
    ...
    public void edit(TarjetaBancaria tarjetaBancaria) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (clienteNew != null && !clienteNew.equals(clienteOld)) {
                TarjetaBancaria oldTarjetaOfCliente = clienteNew.getTarjeta();
                if (oldTarjetaOfCliente != null) {
                    oldTarjetaOfCliente.setCliente(null);
                    oldTarjetaOfCliente = em.merge(oldTarjetaOfCliente);
                }
